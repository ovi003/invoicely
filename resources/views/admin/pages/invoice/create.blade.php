	...
	<div class="container-fluid pl-4 invoice-form-content">
		<div class="card">
			...
			<div class="container-fluid pt-4">
					...
					<div class="form-title-row d-none d-md-block font-weight-bold border-bottom">
						<div class="row">
							<div class="col-md-5">
								Description
							</div>
							<div class="col-md-2 px-1 text-right" style="width: 15%">Quantity</div>
							<div class="col-md-2 px-1 text-right" style="width: 15%">Rate</div>
							<div class="col-md-2 px-1 text-right" style="width: 20%">Amount</div>
						</div>
					</div>
					<div class="row mt-3">
						<div class="col-md-5">
						...
						<div class="col-md-2 col-sm-6 px-md-1 mb-3">
						...
						<div class="col-md-2 col-sm-10 px-md-1 mb-3">
						...
						<div class="col-md-1 col-sm-2 px-md-1 mb-3 text-right">
							<div class="btn-group">
								  <button class="btn dropdown-toggle rounded-0 custom-border p-1" type="button" id="clientList" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<i class="fa fa-cog"></i>
								  </button>
